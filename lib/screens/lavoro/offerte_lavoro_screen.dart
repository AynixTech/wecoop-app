...
class _OfferteLavoroText {
  static const Map<String, Map<String, String>> _values = {
    ...
    'ar': {
      'cannotOpenWhatsapp': 'تعذر فتح واتساب',
      'supportTitle': 'هل تريد البحث عن عمل؟',
      'supportDescription':
          'تصفح الفرص المتاحة على هذه الشاشة أو تواصل مع WECOOP إذا أردت دعماً في التوجيه أو التقديم أو تفعيل الخدمات المخصصة.',
      'refreshOffers': 'تحديث العروض',
      'openOrientation': 'فتح توجيه العمل',
      'contactWecoopWhatsapp': 'تواصل مع WECOOP عبر واتساب',
      'supportWhatsappMessage':
          'مرحباً WECOOP، أودّ الحصول على معلومات حول البحث عن عمل أو تفعيل الخدمات المخصصة.',
      'screenTitle': 'عروض وإعلانات العمل',
      'announcements': 'إعلانات',
      'seek': 'أبحث',
      'offer': 'أعرض',
      'offersInfoTooltip': 'معلومات العروض',
      'orientationTooltip': 'خدمة التوجيه',
      'seekServiceTitle': 'أبحث عن خدمة',
      'seekServiceSubtitle':
          'انشر طلباً: مثلاً أبحث عن جليسة أطفال أو عاملة منزلية أو مساعدة لكبار السن.',
      'offerServiceTitle': 'أعرض خدمة',
      'offerServiceSubtitle':
          'انشر توفرك المهني: مثلاً أعرض خدمة جلوس الأطفال.',
      'sendServiceRequest': 'إرسال طلب الخدمة',
      'sendServiceOffer': 'إرسال عرض الخدمة',
      'filtersTitle': 'فلاتر الإعلانات',
      'searchHint': 'بحث: جليسة أطفال، مرافق، عاملة منزلية، مساعد صحي...',
      'scopes': 'المجالات',
      'all': 'الكل',
      'allFeminine': 'الكل',
      'macroCategories': 'الفئات الرئيسية',
      'macroCategory': 'الفئة الرئيسية',
      ...
      'emptyFiltered':
          'لا توجد إعلانات بهذه الفلاتر. جرّب فئات مثل التنظيف أو المرافق أو جليسة الأطفال.',
      'featured': 'مميز',
      'attachedCv': 'سيرة ذاتية مرفقة',
      'loadMore': 'تحميل المزيد من الإعلانات',
      'detailUnavailable': 'التفاصيل غير متاحة',
      'applicationSent': 'تم إرسال الطلب',
      'applicationError': 'خطأ في الطلب',
      'selectMacroCategory': 'اختر فئة رئيسية',
      'selectSubCategory': 'اختر فئة فرعية',
      'acceptPrivacy': 'يجب قبول موافقة الخصوصية',
      'selectValidSubCategory': 'اختر فئة فرعية صالحة',
      'invalidSubCategoryAfterAi': 'فئة فرعية غير صالحة بعد فحص الذكاء الاصطناعي',
      'imageEncodingError': 'خطأ في ترميز الصورة: {error}',
      'imageLoadingError': 'خطأ في تحميل الصورة: {error}',
      'announcementSentSuccess': 'تم إرسال الإعلان بنجاح!',
      'sendError': 'خطأ في الإرسال',
      'aiCategoryCheck': 'فحص فئة الذكاء الاصطناعي',
      'aiCategoryCheckMessage':
          'الفئة المحددة لا تبدو متسقة مع الوصف.\n\nالاختيار الحالي:\n• الفئة الرئيسية: {currentMacro}\n• الفئة الفرعية: {currentCategory}\n\nاقتراح الذكاء الاصطناعي:\n• الفئة الرئيسية: {suggestedMacro}\n• الفئة الفرعية: {suggestedCategory}{reasonBlock}',
      'reasonLabel': 'السبب: {reason}',
      'cancel': 'إلغاء',
      'sendAnyway': 'إرسال على أي حال',
      'applySuggestion': 'تطبيق الاقتراح',
      'aiSuggestionNotApplicable': 'لا يمكن تطبيق اقتراح الذكاء الاصطناعي على الفئات المتاحة',
      'aiCategoryApplied': 'تم تطبيق فئة الذكاء الاصطناعي',
      'min12BaseDescription': 'أدخل 12 حرفاً على الأقل في الوصف الأساسي',
      'aiDescriptionUnavailable': 'لا يوجد وصف من الذكاء الاصطناعي',
      'improveDescriptionUnavailable': 'تعذر تحسين الوصف',
      'min12Description': 'أدخل 12 حرفاً على الأقل في الوصف',
      'suggestionUnavailable': 'الاقتراح غير متاح',
      'noUsefulSuggestion': 'لم يتم العثور على اقتراح مفيد',
      'aiDescriptionGenerated': 'تم إنشاء وصف بالذكاء الاصطناعي. يمكنك تعديله قبل الإرسال.',
      'aiDescriptionGeneratedWithSource':
          'تم إنشاء وصف بالذكاء الاصطناعي ({source}). يمكنك تعديله قبل الإرسال.',
      'loadMyAnnouncementsError': 'تعذر تحميل إعلاناتك',
      'applyAiSuggestionQuestion': 'هل تطبق اقتراح الذكاء الاصطناعي؟',
      'setSelectionQuestion': 'هل تريد تعيين هذا الاختيار؟\nالفئة الرئيسية: {macro}\nالفئة الفرعية: {category}',
      'no': 'لا',
      'yesApply': 'نعم، تطبيق',
      'suggestionNotApplied': 'لم يتم تطبيق الاقتراح',
      'suggestionWithReason': 'اقتراح {source}: {reason}',
      'suggestedCategoryApplied': 'تم تطبيق الفئة المقترحة',
      'mySeekAnnouncements': 'طلباتي (أبحث)',
      'myOfferAnnouncements': 'عروضي (أعرض)',
      'noAnnouncementsToShow': 'لا توجد لديك إعلانات لعرضها بعد.',
      'announcementFallback': 'إعلان #{id}',
      'withoutCity': 'بدون مدينة',
      'deleteAnnouncementTooltip': 'حذف الإعلان',
      'deleteAnnouncementTitle': 'حذف الإعلان؟',
      'deleteAnnouncementMessage': 'هذا الإجراء سينقل الإعلان إلى سلة المحذوفات.',
      'delete': 'حذف',
      'announcementDeleted': 'تم حذف الإعلان',
      'deleteError': 'خطأ في الحذف',
      'profileCompleteVerified':
          'ملفك الشخصي مكتمل: ستظهر شارة الملف الشخصي المُتحقَّق منه في إعلاناتك.',
      'profileIncompleteVerified':
          'أكمل ملفك الشخصي إذا أردت عرض شارة الملف الشخصي المُتحقَّق منه في إعلاناتك.',
      'myAnnouncements': 'إعلاناتي',
      'announcementTitle': 'عنوان الإعلان',
      'city': 'المدينة',
      'contactLabel': 'هاتف أو بريد إلكتروني للتواصل',
      'description': 'الوصف',
      'descriptionHint': 'صف المهمة/الخدمة والأوقات والمتطلبات الرئيسية',
      'requiredField': 'حقل إلزامي',
      'min20Chars': 'أدخل 20 حرفاً على الأقل',
      'aiImproveRunning': 'تحسين الذكاء الاصطناعي جارٍ...',
      'improveWithAi': 'تحسين الوصف بالذكاء الاصطناعي',
      'aiDescriptionEditable': 'وصف الذكاء الاصطناعي (قابل للتعديل)',
      'aiDescriptionHint': 'الوصف المحسَّن سيظهر هنا. يمكنك تعديله قبل الإرسال.',
      'aiSuggestionRunning': 'اقتراح الذكاء الاصطناعي جارٍ...',
      'suggestCategoryWithAi': 'اقترح فئة بالذكاء الاصطناعي',
      'imageOptional': 'صورة أو صورة (اختياري)',
      'change': 'تغيير',
      'remove': 'إزالة',
      'selectImage': 'اختر صورة',
      'attachGeneratedCv': 'إرفاق سيرة ذاتية منشأة',
      'refreshCv': 'تحديث السيرة الذاتية',
      'attachGeneratedCvHint':
          'إذا كنت تبحث عن عمل، يمكنك ربط إحدى سيرك الذاتية المنشأة. من يفتح الإعلان سيتمكن من الاطلاع عليها.',
      'noGeneratedCv': 'لا توجد سيرة ذاتية منشأة. أنشئ سيرة ذاتية أولاً في قسم السيرة الذاتية بالذكاء الاصطناعي.',
      'attachCvOptional': 'السيرة الذاتية للإرفاق (اختياري)',
      'noCvAttached': 'لا توجد سيرة ذاتية مرفقة',
      'pdfPreview': 'معاينة PDF',
      'openWord': 'فتح Word',
      'privacyConsent': 'أوافق على معالجة البيانات الشخصية',
      'sending': 'الإرسال جارٍ...',
      'insertAnnouncement': 'إضافة إعلان',
      'insertAnnouncementDescription': 'املأ البيانات وأرسل الطلب إلى WECOOP للنشر.',
      'sendAnnouncement': 'إرسال الإعلان',
      'verifiedProfile': 'ملف شخصي مُتحقَّق منه',
      'detailAnnouncement': 'تفاصيل الإعلان',
      'schedule': 'الجدول الزمني',
      'salary': 'الراتب',
      'deadline': 'الموعد النهائي',
      'categories': 'الفئات',
      'attachedResume': 'السيرة الذاتية المرفقة',
      'attachedCvByAuthor': 'سيرة ذاتية مرفقة من صاحب الإعلان',
      'viewCv': 'عرض السيرة الذاتية',
      'phone': 'الهاتف',
      'call': 'اتصال',
      'contactWhatsapp': 'التواصل عبر واتساب',
      'openOriginalAnnouncement': 'فتح الإعلان الأصلي',
      'quickApplication': 'طلب سريع',
      ...
      'selectMacroToSeeSubcategories': 'اختر فئة رئيسية لرؤية الفئات الفرعية المرتبطة.',
    },
    'zh': {
      'cannotOpenWhatsapp': '无法打开WhatsApp',
      'supportTitle': '您想找工作吗？',
      'supportDescription':
          '浏览此屏幕上的可用机会，或联系WECOOP获取求职、申请或激活专属服务的支持。',
      'refreshOffers': '刷新职位',
      'openOrientation': '打开职业指导',
      'contactWecoopWhatsapp': '通过WhatsApp联系WECOOP',
      'supportWhatsappMessage': '你好WECOOP，我想了解找工作或激活专属服务的信息。',
      'screenTitle': '工作招聘与求职公告',
      'announcements': '公告',
      'seek': '求职',
      'offer': '招聘',
      'offersInfoTooltip': '职位信息',
      'orientationTooltip': '指导服务',
      'seekServiceTitle': '我在寻找服务',
      'seekServiceSubtitle': '发布请求：例如我在寻找保姆、家政或老人护理服务。',
      'offerServiceTitle': '我提供服务',
      'offerServiceSubtitle': '发布您的专业技能：例如我提供保姆服务。',
      'sendServiceRequest': '发送服务请求',
      'sendServiceOffer': '发送服务报价',
      'filtersTitle': '公告筛选',
      'searchHint': '搜索：保姆、护理员、家政、健康助理...',
      'scopes': '范围',
      'all': '全部',
      'allFeminine': '全部',
      'macroCategories': '主类别',
      ...
      'apply': '应用',
      'retry': '重试',
      'activeFilters': '筛选（已激活）',
      'openFilters': '打开筛选',
      'emptyFiltered': '此筛选条件下没有公告。尝试清洁、护理或保姆等类别。',
      'featured': '精选',
      'attachedCv': '附简历',
      'loadMore': '加载更多公告',
      'detailUnavailable': '详情不可用',
      'applicationSent': '申请已发送',
      'applicationError': '申请错误',
      'selectMacroCategory': '选择主类别',
      'selectSubCategory': '选择子类别',
      'acceptPrivacy': '您必须接受隐私授权',
      'selectValidSubCategory': '选择有效的子类别',
      'invalidSubCategoryAfterAi': 'AI检查后子类别无效',
      'imageEncodingError': '图片编码错误：{error}',
      'imageLoadingError': '图片加载错误：{error}',
      'announcementSentSuccess': '公告发送成功！',
      'sendError': '发送错误',
      'aiCategoryCheck': 'AI类别检查',
      'aiCategoryCheckMessage':
          '所选类别似乎与描述不一致。\n\n当前选择：\n• 主类别：{currentMacro}\n• 子类别：{currentCategory}\n\nAI建议：\n• 主类别：{suggestedMacro}\n• 子类别：{suggestedCategory}{reasonBlock}',
      'reasonLabel': '原因：{reason}',
      'cancel': '取消',
      'sendAnyway': '仍然发送',
      'applySuggestion': '应用建议',
      'aiSuggestionNotApplicable': 'AI建议不能应用于可用类别',
      'aiCategoryApplied': '已应用AI类别',
      'min12BaseDescription': '请在基础描述中输入至少12个字符',
      'aiDescriptionUnavailable': '无AI描述可用',
      'improveDescriptionUnavailable': '无法改进描述',
      'min12Description': '请在描述中输入至少12个字符',
      'suggestionUnavailable': '建议不可用',
      'noUsefulSuggestion': '未找到有用建议',
      'aiDescriptionGenerated': '已生成AI描述。您可以在发送前修改。',
      'aiDescriptionGeneratedWithSource': '已生成AI描述（{source}）。您可以在发送前修改。',
      'loadMyAnnouncementsError': '无法加载您的公告',
      'applyAiSuggestionQuestion': '应用AI建议？',
      'setSelectionQuestion': '您想设置此选择吗？\n主类别：{macro}\n子类别：{category}',
      'no': '否',
      'yesApply': '是，应用',
      'suggestionNotApplied': '建议未应用',
      'suggestionWithReason': '建议{source}：{reason}',
      'suggestedCategoryApplied': '已应用建议类别',
      'mySeekAnnouncements': '我的请求（求职）',
      'myOfferAnnouncements': '我的报价（招聘）',
      'noAnnouncementsToShow': '您还没有公告可显示。',
      'announcementFallback': '公告 #{id}',
      'withoutCity': '无城市',
      'deleteAnnouncementTooltip': '删除公告',
      'deleteAnnouncementTitle': '删除公告？',
      'deleteAnnouncementMessage': '此操作将把公告移至回收站。',
      'delete': '删除',
      'announcementDeleted': '公告已删除',
      'deleteError': '删除错误',
      'profileCompleteVerified': '您的资料已完整：您的公告将显示已验证资料徽章。',
      'profileIncompleteVerified': '如需在公告中显示已验证资料徽章，请完善您的资料。',
      'myAnnouncements': '我的公告',
      'announcementTitle': '公告标题',
      'city': '城市',
      'contactLabel': '联系电话或邮箱',
      'description': '描述',
      'descriptionHint': '描述职责/服务、时间安排和主要要求',
      'requiredField': '必填项',
      'min20Chars': '请输入至少20个字符',
      'aiImproveRunning': 'AI改进中...',
      'improveWithAi': '用AI改进描述',
      'aiDescriptionEditable': 'AI描述（可编辑）',
      'aiDescriptionHint': '改进后的描述将显示在这里。您可以在发送前修改。',
      'aiSuggestionRunning': 'AI建议中...',
      'suggestCategoryWithAi': '用AI建议类别',
      'imageOptional': '图片或照片（可选）',
      'change': '更改',
      'remove': '移除',
      'selectImage': '选择图片',
      'attachGeneratedCv': '附上生成的简历',
      'refreshCv': '刷新简历',
      'attachGeneratedCvHint': '如果您在找工作，可以关联一份您生成的简历。打开公告的人可以查看。',
      'noGeneratedCv': '没有可用的生成简历。请先在AI简历部分创建简历。',
      'attachCvOptional': '附件简历（可选）',
      'noCvAttached': '未附简历',
      'pdfPreview': 'PDF预览',
      'openWord': '打开Word',
      ...
      'insertAnnouncementDescription': '填写数据并向WECOOP发送发布请求。',
      'sendAnnouncement': '发送公告',
      'verifiedProfile': '已验证资料',
      'detailAnnouncement': '公告详情',
      'schedule': '时间安排',
      'salary': '薪资',
      'deadline': '截止日期',
      'categories': '类别',
      'attachedResume': '附件简历',
      'attachedCvByAuthor': '公告作者附上的简历',
      'viewCv': '查看简历',
      'phone': '电话',
      'call': '拨打',
      'contactWhatsapp': '通过WhatsApp联系',
      'openOriginalAnnouncement': '打开原始公告',
      'quickApplication': '快速申请',
      'fullName': '姓名',
      ...
      'selectMacroToSeeSubcategories': '选择主类别以查看对应的子类别。',
    },
  };
